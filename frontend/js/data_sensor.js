...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function displayData(data) {
    ...
    // Iterate through each data row and create a new table row element
    data.forEach((row) => {
  ...
  function getDataForPage(page, pageSize) {
    ...
    fetch(
      `http://localhost:2002/data_sensor?page=${page}&pageSize=${pageSize}&sortField=${sortField}&sortBy=${sortBy}&keyword=${keyword}&searchField=${searchField}`
    )
